<template>
    ...
    <div class="flex justify-center flex-col items-center min-h-screen bg-opacity-50 bg-black">
        ...
        <div class="absolute left-[33%] top-[25%] p-1 space-y-5 font-cuaderno w-[290px]">
            <!-- TITULO -->
            <div class="text-black font-bold text-4xl text-center mb-5">
                <p>TO DO</p>
                <hr class="border-black">
            </div>

            <!-- PRIMERA PARTE (Tablet) -->
            <div :class="tablet ? 'text-gray-700 line-through' : 'text-gray-600'">
            ...
            <!-- SEGUNDA PARTE (Apps) -->
            <div>
                <p :class="completado ? 'text-gray-700 line-through' : 'text-gray-600'">- Aplicaciones pendientes de acceso:</p>
            ...
            <div :class="completado ? 'text-gray-700 line-through' : 'text-gray-600'">
