<template>
  <UserCard class="z-10"/>
  <router-link to="/ranking" class="absolute top-7 left-4 flex flex-col items-end z-10 bg-[#0ED800] px-[5px] py-[2px] text-sm active:shadow-none active:translate-y-[5px] rounded-[5px] btn__ranking cursor-pointer">
    Ranking
  </router-link>
